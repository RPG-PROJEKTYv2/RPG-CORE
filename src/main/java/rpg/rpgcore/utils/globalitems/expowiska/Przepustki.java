...
public enum Przepustki {
    I1(100_000,"I1", new ItemBuilder(Material.PAPER).setName("&eWejsciowka do &bSwiatyni").setLore(Arrays.asList("&7Jednorazowa wejsciowka...")).toItemStack().clone()),
    I2(250_000,"I2", new ItemBuilder(Material.PAPER).setName("&eWejsciowka do &fKrysztalowej Sali").setLore(Arrays.asList("&7Jednorazowa wejsciowka...")).toItemStack().clone()),
    I3(500_000,"I3", new ItemBuilder(Material.PAPER).setName("&eWejsciowka do &6Tajemniczej Siedziby").setLore(Arrays.asList("&7Jednorazowa wejsciowka...")).toItemStack().clone()),
