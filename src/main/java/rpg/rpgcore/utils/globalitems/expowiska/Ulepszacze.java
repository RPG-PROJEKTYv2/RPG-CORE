...
public enum Ulepszacze {
    ...
    I_SZAFIROWESERCE("100-110", new ItemBuilder(Material.INK_SACK, 1, (short)4).setName("&bSzafirowe Serce").setLore(Arrays.asList("&8&oUlepszacz")).hideFlag().toItemStack().clone()),
