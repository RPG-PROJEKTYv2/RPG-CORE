...
public enum Dungeony {
    ...
    // ogolnikowe
    I_SAKIEWKA_ULEPSZACZY("I_SAKIEWKA_ULEPSZACZY", new ItemBuilder(Material.FLOWER_POT_ITEM).setName("&fSakiewka Z Ulepszaczami").setLore(Arrays.asList("", "&7Kliknij aby otworzyc...")).toItemStack().clone()),
    // 60-70
