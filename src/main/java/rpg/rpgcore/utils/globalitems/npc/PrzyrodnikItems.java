...
public enum PrzyrodnikItems {
    ...
    I8("80-90", new ItemBuilder(Material.SUGAR, 1, (short) 10).setName("&aToksyczny Zab Ptasznika").setLore(Arrays.asList("&8&oChyba Przyrodnik tego potrzebuje...")).toItemStack().clone()),
    ...
    I12("120-130", new ItemBuilder(Material.GHAST_TEAR).setName("&9Smocza Luska").setLore(Arrays.asList("&8&oChyba Przyrodnik tego potrzebuje...")).toItemStack().clone());
