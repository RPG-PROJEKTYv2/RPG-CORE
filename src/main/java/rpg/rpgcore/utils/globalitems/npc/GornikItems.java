...
public enum GornikItems {
    ...
    P1("P1", new ItemBuilder(Material.COAL).setName("&0Polyskujacy Krysztal Mroku").setLore(Arrays.asList("&8&oPieknie mieni sie w blasku slonca...")).toItemStack()),
    ...
    S1("S1", new ItemBuilder(Material.COAL).setName("&0Lsniacy Krysztal Mroku").setLore(Arrays.asList("&8&oPieknie blyszczy sie w blasku slonca...")).toItemStack()),
    ...
    C1("C1", new ItemBuilder(Material.COAL).setName("&0Czysty Krysztal Mroku").setLore(Arrays.asList("&8&oPosiada niesamowite wlasciwosci &eszlacheckie", "&8&oMozliwy do zalozenia na ostrze")).toItemStack()),
    ...
    W1("W1", new ItemBuilder(Material.COAL).setName("&0Wypolerowany Krysztal Mroku").setLore(Arrays.asList("&8&oPosiada niesamowite wlasciwosci &6Krolewskie", "&8&oMozliwy do zalozenia na ostrze")).toItemStack()),
