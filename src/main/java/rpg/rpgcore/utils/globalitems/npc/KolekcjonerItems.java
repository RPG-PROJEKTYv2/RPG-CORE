...
public enum KolekcjonerItems {
    ...
    // EXPOWISKO 1
    I1_10_1("1-10-1", ItemHelper.createArmor("&8Zaginiona Czapka Najemnika", Material.LEATHER_HELMET, 10, 1,true)),
    I1_10_2("1-10-2", ItemHelper.createArmor("&8Zaginiona Koszula Najemnika", Material.LEATHER_CHESTPLATE, 10, 1,true)),
    I1_10_3("1-10-3", ItemHelper.createArmor("&8Zaginione Spodnie Najemnika", Material.LEATHER_LEGGINGS, 10, 1,true)),
    I1_10_4("1-10-4", ItemHelper.createArmor("&8Zaginiona Buty Najemnika", Material.LEATHER_BOOTS, 10, 1,true)),
    // EXPOWISKO 2
    // SOON...
