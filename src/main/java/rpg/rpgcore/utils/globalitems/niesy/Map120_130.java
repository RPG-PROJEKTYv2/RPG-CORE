...
public enum Map120_130 {
    ...
    I120_130_6("120-130-6", 10, new ItemBuilder(Material.STORAGE_MINECART).setName("&6&lStarozytny Naszyjnik").toItemStack()),
    I120_130_7("120-130-7", 10, new ItemBuilder(Material.WATCH).setName("&6&lStarozytny Diadem").toItemStack()),
    I120_130_8("120-130-8", 10, new ItemBuilder(Material.ITEM_FRAME).setName("&9&lStarozytna Tarcza").toItemStack()),
    I120_130_9("120-130-9", 10, new ItemBuilder(Material.HOPPER_MINECART).setName("&9&lStarozytne Kolczyki").toItemStack()),
    I120_130_10("120-130-10", 10, new ItemBuilder(Material.EXPLOSIVE_MINECART).setName("&9&lStarozytny Pierscien").toItemStack()),
    I120_130_11("120-130-11", 6, new ItemBuilder(Material.MINECART).setName("&9&lStarozytna Energia").toItemStack()),
    I120_130_12("120-130-12", 6, new ItemBuilder(Material.FIREBALL).setName("&9&lStarozytny Medalion").toItemStack()),
    I120_130_13("120-130-13", 6, new ItemBuilder(Material.LEASH).setName("&9&lStarozytny Pas").toItemStack()),
    I120_130_14("120-130-14", 6, new ItemBuilder(Material.LADDER).setName("&9&lStarozytna Szarfa").toItemStack());
            ...
            if (item.getChance() + szczescie >= 100.0 || item.getChance() + szczescie > ThreadLocalRandom.current().nextDouble(0.0, 100.0)) {
                ...
                if (item.getRewardItem().getType() == Material.MINECART) {
                    player.getInventory().addItem(AkcesoriaDodatHelper.createEnergia(ChanceHelper.getRandInt(-65, -47), ChanceHelper.getRandInt(65, 85),
                            ChanceHelper.getRandInt(65, 85), ChanceHelper.getRandDouble(0.3, 0.6), ChanceHelper.getRandInt(-85, -60),ChanceHelper.getRandInt(120, 130), "&9&lStarozytna Energia"));
                    return;
                }
                if (item.getRewardItem().getType() == Material.FIREBALL) {
                    player.getInventory().addItem(AkcesoriaDodatHelper.createMedalion(ChanceHelper.getRandInt(25, 35), ChanceHelper.getRandInt(30, 45), ChanceHelper.getRandInt(120, 130),"&9&lStarozytny Medalion"));
                    return;
                }
                if (item.getRewardItem().getType() == Material.LEASH) {
                    player.getInventory().addItem(AkcesoriaDodatHelper.createPas(ChanceHelper.getRandInt(35, 50), ChanceHelper.getRandInt(35, 50), ChanceHelper.getRandInt(120, 130), "&9&lStarozytny Pas"));
                    return;
                }
                if (item.getRewardItem().getType() == Material.LADDER) {
                    player.getInventory().addItem(AkcesoriaDodatHelper.createSzarfa(ChanceHelper.getRandInt(21, 30), ChanceHelper.getRandInt(21, 30), ChanceHelper.getRandInt(120, 130), "&9&lStarozytna Szarfa"));
                    return;
                }
