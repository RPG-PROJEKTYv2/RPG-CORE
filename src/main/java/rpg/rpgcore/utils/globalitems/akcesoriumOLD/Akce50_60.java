...
public enum Akce50_60 {
    I50_60_1("50-60-1", 13, new ItemBuilder(Material.ITEM_FRAME).setName("&f&lSniezna Tarcza").toItemStack(), 25, 33, 18, 29, 8, 13),
    I50_60_2("50-60-2", 12, new ItemBuilder(Material.EXPLOSIVE_MINECART).setName("&f&lSniezny Pierscien").toItemStack(), 15, 19, 15, 20, 45, 65),
    I50_60_3("50-60-3", 11, new ItemBuilder(Material.WATCH).setName("&f&lSniezny Diadem").toItemStack(), 20, 22, 20, 28, 3, 6),
    I50_60_4("50-60-4", 10, new ItemBuilder(Material.STORAGE_MINECART).setName("&f&lSniezny Naszyjnik").toItemStack(), 12, 14, 16, 18, -60, -50),
    I50_60_5("50-60-5", 9, new ItemBuilder(Material.HOPPER_MINECART).setName("&f&lSniezne Kolczyki").toItemStack(), 13, 19, 10, 16, 50, 60);
    ...
    Akce50_60(String name, double dropChance, ItemStack item, int min1, int max1, int min2, int max2, int min3, int max3) {
        this.name = name;
    ...
    public static Akce50_60 getByAkceName(final String name) {
        for (final Akce50_60 akce : values()) {
