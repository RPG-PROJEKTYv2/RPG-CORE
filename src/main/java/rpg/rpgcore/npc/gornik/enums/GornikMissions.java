...
public enum GornikMissions {
    ...
    M20(20, Arrays.asList("&7Przerob &61500 &2&lRudy Jadeitu", "&f&lNagroda", "&7Srednia Odpornosc: &c1%"), 1500,  GlobalItem.getItem("I2", 1), 1, 0,0),
    ...
    M27(27, Arrays.asList("&7Wykop &6128 &8&lSkrzyn Gornika", "&f&lNagroda", "&7Srednia Odpornosc: &c2%", "&7Przeszycie Bloku Ciosu: &c5%", "&7Blok Ciosu: &c5%"), 128,  GlobalItem.getItem("I2", 1), 2, 0,0),
    M28(28, Arrays.asList("&7Sprzedaj &612500 &7krysztalow", "&f&lNagroda", "&7Srednia Odpornosc: &c2%"), 12500,  GlobalItem.getItem("I2", 1), 2, 5,5),
