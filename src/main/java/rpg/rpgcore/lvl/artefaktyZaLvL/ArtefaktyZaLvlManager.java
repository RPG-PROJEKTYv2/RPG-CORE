...
public class ArtefaktyZaLvlManager {
    ...
    public void checkArteZaLvl(final Player player, final int lvl) {
        if (lvl == 50) {
            ...
            if (artefaktyZaLvl.getPoziom50().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom50().setNadanych(artefaktyZaLvl.getPoziom50().getNadanych() + 1);
            artefaktyZaLvl.getPoziom50().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 60) {
            ...
            if (artefaktyZaLvl.getPoziom60().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom60().setNadanych(artefaktyZaLvl.getPoziom60().getNadanych() + 1);
            artefaktyZaLvl.getPoziom60().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 70) {
            ...
            if (artefaktyZaLvl.getPoziom70().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom70().setNadanych(artefaktyZaLvl.getPoziom70().getNadanych() + 1);
            artefaktyZaLvl.getPoziom70().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 80) {
            ...
            if (artefaktyZaLvl.getPoziom80().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom80().setNadanych(artefaktyZaLvl.getPoziom80().getNadanych() + 1);
            artefaktyZaLvl.getPoziom80().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 90) {
            ...
            if (artefaktyZaLvl.getPoziom90().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom90().setNadanych(artefaktyZaLvl.getPoziom90().getNadanych() + 1);
            artefaktyZaLvl.getPoziom90().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 100) {
            ...
            if (artefaktyZaLvl.getPoziom100().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom100().setNadanych(artefaktyZaLvl.getPoziom100().getNadanych() + 1);
            artefaktyZaLvl.getPoziom100().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 110) {
            ...
            if (artefaktyZaLvl.getPoziom110().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom110().setNadanych(artefaktyZaLvl.getPoziom110().getNadanych() + 1);
            artefaktyZaLvl.getPoziom110().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 120) {
            ...
            if (artefaktyZaLvl.getPoziom120().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom120().setNadanych(artefaktyZaLvl.getPoziom120().getNadanych() + 1);
            artefaktyZaLvl.getPoziom120().getGracze().add(player.getUniqueId());
        ...
        if (lvl == 130) {
            ...
            if (artefaktyZaLvl.getPoziom130().getGracze().contains(player.getUniqueId())) return;
            artefaktyZaLvl.getPoziom130().setNadanych(artefaktyZaLvl.getPoziom130().getNadanych() + 1);
            artefaktyZaLvl.getPoziom130().getGracze().add(player.getUniqueId());
