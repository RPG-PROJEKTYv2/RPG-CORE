...
public enum Maps {
    ...
    MAP_30_40_1("Zjawa Lvl. 32", 256.7, 100, 30, 40),
    MAP_30_40_2("Zjawa Lvl. 36", 342.3, 115, 30, 40),
    MAP_30_40_3("Zjawa Lvl. 39", 427.9, 130, 30, 40),
    MAP_30_40_BOSS("[BOSS] Przekleta Dusza", 1_900.5, 24_750, 30, 40),
    MAP_40_50_1("Straznik Swiatyni Lvl. 43", 1144.4, 200, 40, 50),
    MAP_40_50_2("Straznik Swiatyni Lvl. 46", 1525.9, 250, 40, 50),
    MAP_40_50_3("Straznik Swiatyni Lvl. 47", 1907.3, 300, 40, 50),
    MAP_40_50_BOSS("[BOSS] Tryton", 9_344.1, 80_000, 40, 50),
    MAP_50_60_1("Mrozny Wilk Lvl. 52", 1750.2, 320, 50, 60),
    MAP_50_60_2("Mrozny Wilk Lvl. 54", 2384.3, 380, 50, 60),
    MAP_50_60_3("Mrozny Wilk Lvl. 56", 2980.3, 420, 50, 60),
    MAP_60_70_1("Zywiolak Ognia Lvl. 64", 5_524.7, 500, 60, 70),
    MAP_60_70_2("Zywiolak Ognia Lvl. 66", 7_366.3, 550, 60, 70),
    MAP_60_70_3("Zywiolak Ognia Lvl. 68", 9_207.8, 600, 60, 70),
    MAP_60_70_BOSS("[BOSS] Piekielny Rycerz", 205_542.0, 336_000, 60, 70),
    MAP_70_80_1("Mroczna Dusza Lvl. 71", 16_596.0, 680, 70, 80),
    MAP_70_80_2("Mroczna Dusza Lvl. 75", 22_129.0, 700, 70, 80),
    MAP_70_80_3("Mroczna Dusza Lvl. 78", 27_661.0, 760, 70, 80),
    MAP_70_80_BOSS("[BOSS] Przeklety  Czarnoksieznik", 1_229_367.0, 500_000, 70, 80),
    ...
    MAP_90_100_1(" Lvl. ", 159_756.0, 750, 90, 100),
