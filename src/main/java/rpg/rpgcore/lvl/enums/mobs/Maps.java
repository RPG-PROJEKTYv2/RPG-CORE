...
public enum Maps {
    ...
    MAP_1_10_1("Rozbojnik Lvl. 3", 3.8, 1, 1, 10),
    MAP_1_10_2("Rozbojnik Lvl. 5", 5, 2, 1, 10),
    MAP_1_10_3("Rozbojnik Lvl. 7", 6.3, 3, 1, 10),
    MAP_1_10_BOSS("[BOSS] Dowodca Rozbojnikow", 20, 300, 1, 10),
    MAP_10_20_1("Goblin Lvl. 14", 13.8, 5, 10, 20),
    MAP_10_20_2("Goblin Lvl. 16", 18.4, 6, 10, 20),
    MAP_10_20_3("Goblin Lvl. 19", 22.9, 7, 10, 20),
    MAP_10_20_BOSS("[BOSS] Wodz Goblinow", 75, 600, 10, 20),
    MAP_20_30_1("Goryl Lvl. 21", 52.4, 11, 20, 30),
    MAP_20_30_2("Goryl Lvl. 25", 69.8, 12, 20, 30),
    MAP_20_30_3("Goryl Lvl. 28", 87.3, 13, 20, 30),
    MAP_20_30_BOSS("[BOSS] Krol Goryli", 300.5, 2_000, 20, 30),
    MAP_30_40_1("Zjawa Lvl. 32", 256.7, 15, 30, 40),
    MAP_30_40_2("Zjawa Lvl. 36", 342.3, 16, 30, 40),
    MAP_30_40_3("Zjawa Lvl. 39", 427.9, 17, 30, 40),
    MAP_30_40_BOSS("[BOSS] Przekleta Dusza", 1_900.5, 10_000, 30, 40),
    MAP_40_50_1("Straznik Swiatyni Lvl. 43", 21, 200, 40, 50),
    MAP_40_50_2("Straznik Swiatyni Lvl. 46", 22, 250, 40, 50),
    MAP_40_50_3("Straznik Swiatyni Lvl. 47", 23, 300, 40, 50),
    MAP_40_50_BOSS("[BOSS] Tryton", 9_344.1, 40_000, 40, 50),
    MAP_50_60_1("Mrozny Wilk Lvl. 52", 1750.2, 75, 50, 60),
    MAP_50_60_2("Mrozny Wilk Lvl. 54", 2384.3, 77, 50, 60),
    MAP_50_60_3("Mrozny Wilk Lvl. 56", 2980.3, 80, 50, 60),
    ...
    MAP_80_90_1(" Lvl. ", 55_396.0, 170, 80, 90),
    MAP_80_90_2(" Lvl. ", 73_861.0, 180, 80, 90),
    MAP_80_90_3(" Lvl. ", 92_327.0, 190, 80, 90),
    MAP_80_90_BOSS(" Lvl. ", 5_908_910.0, 2_000_000, 80, 90),
    MAP_90_100_1(" Lvl. ", 159_756.0, 250, 90, 100),
    MAP_90_100_2(" Lvl. ", 213_007.0, 260, 90, 100),
    MAP_90_100_3(" Lvl. ", 266_259.0, 280, 90, 100),
    MAP_90_100_BOSS(" Lvl. ", 26_625_921.0, 3_550_000, 90, 100),
