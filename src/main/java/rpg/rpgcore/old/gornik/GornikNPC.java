package rpg.rpgcore.old.gornik;
...
import rpg.rpgcore.old.gornik.enums.GornikDlutoLevels;
import rpg.rpgcore.old.gornik.enums.GornikLevels;
...
public class GornikNPC {
    ...
    public void openCraftingiKrysztalow(final Player player) {
        final Inventory gui = Bukkit.createInventory(null, 54, Utils.format("&6&lWytwarzanie Krysztalow"));
        for (int i = 0; i < 54; i++) {
