...
public final class RPGCORE extends JavaPlugin {
    ...
    private void initGlobalCommands() {
        ...
        CommandAPI.getCommand().register("HellRPGCore", new BossyCommand(this));
        ...
        CommandAPI.getCommand().register("HellRPGCore", new TestAnimationCommand(this));
        CommandAPI.getCommand().register("HellRPGCore", new TestCommand(this));
