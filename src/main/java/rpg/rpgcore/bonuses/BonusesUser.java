...
public class BonusesUser {
    private int dodatkowehp, dodatkowezlotehp, dodatkoweobrazenia, truedamage, szczescie, szybkosc;
    private double srednieobrazenia, silnynaludzi, silnynapotwory, sredniadefensywa, defnaludzi, defnamoby, szansanakryta, szansanawzmocnieniekryta, blokciosu, przeszyciebloku, szansanakrwawienie, minussrednieobrazenia, minussredniadefensywa, minusdefnaludzi, minusdefnamoby, minusobrazenianaludzi, minusobrazenianamoby, spowolnienie, dodatkowyExp, oslepienie, przebiciePancerza, wampiryzm, wzmocnienieKryta;
    ...
    public BonusesUser(int dodatkowehp, int dodatkowezlotehp, int dodatkoweobrazenia, int truedamage, double srednieobrazenia, double silnynaludzi, double silnynapotwory, double sredniadefensywa,
                       ...
                       int szczescie, int szybkosc, double spowolnienie, double dodatkowyExp, double oslepienie, double przebiciePancerza, double wampiryzm, double wzmocnienieKryta) {
