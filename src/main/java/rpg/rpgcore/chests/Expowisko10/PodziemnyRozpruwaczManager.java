...
public class PodziemnyRozpruwaczManager {
    ...
    public PodziemnyRozpruwaczManager() {
        this.podziemnyrozpruwacz.add(new Items("1", 10.0, ItemHelper.createArmor("&6&lHelm Podziemnego Rozpruwacza", Material.IRON_HELMET, 70, 17), 1));
        this.podziemnyrozpruwacz.add(new Items("2", 10.0, ItemHelper.createArmor("&6&lZbroja Podziemnego Rozpruwacza", Material.IRON_CHESTPLATE, 73, 17), 1));
        this.podziemnyrozpruwacz.add(new Items("3", 10.0, ItemHelper.createArmor("&6&lSpodnie Podziemnego Rozpruwacza", Material.IRON_LEGGINGS, 73, 17), 1));
        this.podziemnyrozpruwacz.add(new Items("4", 10.0, ItemHelper.createArmor("&6&lButy Podziemnego Rozpruwacza", Material.IRON_BOOTS, 67, 16), 1));
        this.podziemnyrozpruwacz.add(new Items("5", 8.0, ItemHelper.createSword("&6&lMiecz Podziemnego Rozpruwacza", Material.IRON_SWORD, 40, 40,false), 1));
