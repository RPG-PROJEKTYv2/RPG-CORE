...
public class PodziemnyRozpruwaczManager {
    ...
    public PodziemnyRozpruwaczManager() {
        this.podziemnyrozpruwacz.add(new Items("1", 8.0, ItemHelper.createArmor("&6&lHelm Podziemnego Rozpruwacza", Material.IRON_HELMET, 30, 1), 1));
        this.podziemnyrozpruwacz.add(new Items("2", 8.0, ItemHelper.createArmor("&6&lZbroja Podziemnego Rozpruwacza", Material.IRON_CHESTPLATE, 30, 1), 1));
        this.podziemnyrozpruwacz.add(new Items("3", 8.0, ItemHelper.createArmor("&6&lSpodnie Podziemnego Rozpruwacza", Material.IRON_LEGGINGS, 30, 1), 1));
        this.podziemnyrozpruwacz.add(new Items("4", 8.0, ItemHelper.createArmor("&6&lButy Podziemnego Rozpruwacza", Material.IRON_BOOTS, 30, 1), 1));
