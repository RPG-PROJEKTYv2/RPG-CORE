...
public class GornikChestManager {
    ...
    public GornikChestManager() {
        ...
        this.gorniknpc.add(new Items("6", 4.0, GornikItems.getItem("Skrzynia_Gornika", 1), 3));
        ...
        this.gorniknpc.add(new Items("12", 5.0, GornikItems.getItem("Skrzynia_Gornika", 1), 2));
