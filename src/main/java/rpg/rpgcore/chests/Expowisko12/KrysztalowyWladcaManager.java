...
public class KrysztalowyWladcaManager {
    ...
    public KrysztalowyWladcaManager() {
        this.krysztalowyboss.add(new Items("1", 8.0, ItemHelper.createArmor("&b&lHelm Krysztalowego Wladcy", Material.DIAMOND_HELMET, 85, 18), 1));
        this.krysztalowyboss.add(new Items("2", 8.0, ItemHelper.createArmor("&b&lZbroja Krysztalowego Wladcy", Material.DIAMOND_CHESTPLATE, 85, 18), 1));
        this.krysztalowyboss.add(new Items("3", 8.0, ItemHelper.createArmor("&b&lSpodnie Krysztalowego Wladcy", Material.DIAMOND_LEGGINGS, 85, 17), 1));
        this.krysztalowyboss.add(new Items("4", 8.0, ItemHelper.createArmor("&b&lButy Krysztalowego Wladcy", Material.DIAMOND_BOOTS, 82, 18), 1));
        this.krysztalowyboss.add(new Items("5", 6.0, ItemHelper.createSword("&b&lMiecz Krysztalowego Wladcy", Material.DIAMOND_SWORD, 60, 50, false), 1));
