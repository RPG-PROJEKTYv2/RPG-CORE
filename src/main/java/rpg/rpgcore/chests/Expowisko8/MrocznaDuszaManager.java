...
public class MrocznaDuszaManager {
    ...
    public MrocznaDuszaManager() {
        ...
        this.mrocznadusza.add(new Items("2", 18.0, ItemHelper.createArmor("&7Helm Mrocznej Duszy", Material.DIAMOND_HELMET, 35, 6), 1));
        this.mrocznadusza.add(new Items("3", 18.0, ItemHelper.createArmor("&7Zbroja Mrocznej Duszy", Material.DIAMOND_CHESTPLATE, 35, 7), 1));
        this.mrocznadusza.add(new Items("4", 18.0, ItemHelper.createArmor("&7Spodnie Mrocznej Duszy", Material.DIAMOND_LEGGINGS, 35, 7), 1));
