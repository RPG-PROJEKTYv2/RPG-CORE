...
public class PrzekletyCzarnoksieznikManager {
    ...
    public PrzekletyCzarnoksieznikManager() {
        this.przekletyczarnoksieznik.add(new Items("1", 5.0, new ItemBuilder(Material.HOPPER_MINECART).setName("&5&lKolczyki Przekletego Czarnoksieznika").toItemStack(),1 ));
        this.przekletyczarnoksieznik.add(new Items("2", 6.0, new ItemBuilder(Material.STORAGE_MINECART).setName("&5&lNaszyjnik Przekletego Czarnoksieznika").toItemStack(),1 ));
        this.przekletyczarnoksieznik.add(new Items("3", 7.0, new ItemBuilder(Material.WATCH).setName("&5&lDiadem Przekletego Czarnoksieznika").toItemStack(),1 ));
        ...
        this.przekletyczarnoksieznik.add(new Items("9", 16.0, ItemHelper.createArmor("&5&lSpodnie Przekletego Czarnoksieznika", Material.DIAMOND_LEGGINGS, 60, 15), 1));
