...
public class PrzekletyCzarnoksieznikManager {
    ...
    public PrzekletyCzarnoksieznikManager() {
        this.przekletyczarnoksieznik.add(new Items("1", 8.0, ItemHelper.createArmor("&5&lHelm Przekletego Czarnoksieznika", Material.IRON_HELMET, 30, 1), 1));
        this.przekletyczarnoksieznik.add(new Items("2", 8.0, ItemHelper.createArmor("&5&lZbroja Przekletego Czarnoksieznika", Material.IRON_CHESTPLATE, 30, 1), 1));
        this.przekletyczarnoksieznik.add(new Items("3", 8.0, ItemHelper.createArmor("&5&lSpodnie Przekletego Czarnoksieznika", Material.IRON_LEGGINGS, 30, 1), 1));
        this.przekletyczarnoksieznik.add(new Items("4", 8.0, ItemHelper.createArmor("&5&lButy Przekletego Czarnoksieznika", Material.IRON_BOOTS, 30, 1), 1));
