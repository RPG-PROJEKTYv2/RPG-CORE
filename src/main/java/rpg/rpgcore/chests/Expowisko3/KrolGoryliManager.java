...
public class KrolGoryliManager {
    ...
    public KrolGoryliManager() {
        this.krolgoryli.add(new Items("1", 8.0, ItemHelper.createArmor("&f&lHelm Krola Goryli", Material.GOLD_HELMET, 17, 0), 1));
        this.krolgoryli.add(new Items("2", 8.0, ItemHelper.createArmor("&f&lZbroja Krola Goryli", Material.GOLD_CHESTPLATE, 17, 0), 1));
        this.krolgoryli.add(new Items("3", 8.0, ItemHelper.createArmor("&f&lSpodnie Krola Goryli", Material.GOLD_LEGGINGS, 17, 0), 1));
        this.krolgoryli.add(new Items("4", 8.0, ItemHelper.createArmor("&f&lButy Krola Goryli", Material.GOLD_BOOTS, 17, 0), 1));
