...
public class SurowceManager {
    ...
    public SurowceManager() {
        ...
        surowce.add(new Items("13", 1.0, GlobalItem.getItem("I16", 1), 2));
        surowce.add(new Items("14", 1.0, GlobalItem.getItem("I17", 1), 2));
        surowce.add(new Items("15", 0.5, GlobalItem.getItem("I18", 1), 2));
        // SZANSA NA 3
        surowce.add(new Items("16", 1.5, GlobalItem.getItem("I12", 1), 3));
        surowce.add(new Items("17", 1.5, GlobalItem.getItem("I13", 1), 3));
        surowce.add(new Items("18", 1.0, GlobalItem.getItem("I14", 1), 3));
        surowce.add(new Items("19", 1.0, GlobalItem.getItem("I15", 1), 3));
        surowce.add(new Items("20", 0.5, GlobalItem.getItem("I16", 1), 3));
        surowce.add(new Items("21", 0.5, GlobalItem.getItem("I17", 1), 3));
        surowce.add(new Items("22", 0.225, GlobalItem.getItem("I18", 1), 3));
        // tajemnicza
