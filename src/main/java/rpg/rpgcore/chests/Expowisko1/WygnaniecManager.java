...
public class WygnaniecManager {
    ...
    public WygnaniecManager() {
        this.wygnaniec.add(new Items("1", 8.0, ItemHelper.createArmor("&8&lHelm Wygnanca", Material.LEATHER_HELMET, 6, 0,false), 1));
        this.wygnaniec.add(new Items("2", 8.0, ItemHelper.createArmor("&8&lZbroja Wygnanca", Material.LEATHER_CHESTPLATE, 6, 0,false), 1));
        this.wygnaniec.add(new Items("3", 8.0, ItemHelper.createArmor("&8&lSpodnie Wygnanca", Material.LEATHER_LEGGINGS, 6, 0,false), 1));
        this.wygnaniec.add(new Items("4", 8.0, ItemHelper.createArmor("&8&lButy Wygnanca", Material.LEATHER_BOOTS, 6, 0,false), 1));
