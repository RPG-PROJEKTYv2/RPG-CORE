...
public class WygnaniecManager {
    ...
    public WygnaniecManager() {
        ...
        this.wygnaniec.add(new Items("10", 2.0, new ItemBuilder(Material.STORAGE_MINECART).setName("&8&lUlepszony Naszyjnik Wygnanca").toItemStack(),1 ));
        this.wygnaniec.add(new Items("11", 2.0, new ItemBuilder(Material.WATCH).setName("&8&lUlepszony Diadem Wyganca").toItemStack(),1 ));
        this.wygnaniec.add(new Items("12", 2.0, new ItemBuilder(Material.EXPLOSIVE_MINECART).setName("&8&lUlepszony Pierscien Wyganca").toItemStack(),1 ));
        this.wygnaniec.add(new Items("13", 2.0, new ItemBuilder(Material.ITEM_FRAME).setName("&8&lUlepszona Tarcza Wygnanca").toItemStack(),1 ));
    }
